...
<body>
    ...
    <div id="bannerContainer">
        ...
        <section class = "hero" id="hero2">
            <h4>Tell us your impression</h4>
            <h2>Fast response</h2>
            <h1>For all messages</h1>
            <p>we will always be there for you </p>
            <a href="contact.php"><button>contact Now</button></a>
            <div id="arrowContainer">
            <button onclick="changeBanner(-1)">❮</button>
            <button onclick="changeBanner(1)">❯</button>
            </div>
        ...
        <section class = "hero" id="hero3">
            ...
            <h1> all of our pages</h1>
            <p>we will always be there for you </p>
            <a href="about.php"><button>know Now</button></a>
            <div id="arrowContainer">
            <button onclick="changeBanner(-1)">❮</button>
            <button onclick="changeBanner(1)">❯</button>
            </div>
    ...
    <script>
        ...
        function showBanner(n) {
            ...
            for (let i = 1; i <= totalBanners; i++) {
                document.getElementById(`hero${i}`).style.display = 'none';
            }

            // Show the selected banner
            document.getElementById(`hero${n}`).style.display = 'block';
        }

        function changeBanner(n) {
            currentBanner += n;

            // Wrap around to the first banner if going beyond the last one
            if (currentBanner > totalBanners) {
                currentBanner = 1;
            }

            // Wrap around to the last banner if going before the first one
            if (currentBanner < 1) {
    ...
    <footer class="section-p1">
        <div class="col">
            ...
            <h2 class="logo" style="font-family: 'Dancing Script', cursive; color: #088178">Prime Menswear<i class="fa-solid fa-shirt" style=" font-size: 20px;"></i></h2>
            <h4>Contact</h4>
