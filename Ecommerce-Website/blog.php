    ...
    <section id="blog">
        ...
        <div class="blog-box">
            ...
            <div class="blog-details">
                ...
                <a onclick="myFunction1()" id="myBtn1" href="javascript:void(0)">CONTINUE READING</a>
            </div>
            <h1>13/04</h1>
        </div>
        <div class="blog-box">
            <div class="blog-img">
                <img src="img/blog/b21.jpg" alt="">
            </div>
            <div class="blog-details">
                <h4>The Cotton-Jersey Zip-Up Hoodie</h4>
                ...
                <a onclick="myFunction2()" id="myBtn2" href="javascript:void(0)">CONTINUE READING</a>
            </div>
            <h1>12/01</h1>
        </div>
        <div class="blog-box">
            <div class="blog-img">
                <img src="img/blog/b20.jpg" alt="">
            </div>
            <div class="blog-details">
                <h4>The Cotton-Jersey Zip-Up Hoodie</h4>
                ...
                <a onclick="myFunction3()" id="myBtn3" href="javascript:void(0)">CONTINUE READING</a>
            </div>
            <h1>16/01</h1>
        </div>
        <div class="blog-box">
            <div class="blog-img">
                <img src="img/blog/b18.jpg" alt="">
            </div>
            <div class="blog-details">
                <h4>The Cotton-Jersey Zip-Up Hoodie</h4>
                ...
                <a onclick="myFunction4()" id="myBtn4" href="javascript:void(0)">CONTINUE READING</a>
            </div>
            <h1>10/03</h1>
        </div>
    </section>
