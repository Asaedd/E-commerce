...
<head>
    ...
    <title>Winter Collection-page</title>
...
<body>
    ...
    <section id="product1" class="section-p1">
        <h2>Get <span style="color: #ff523b;">Winter</span> Collection</h2>
        <p>New Winter Arrivals</p>
        <div class="pro-container">
            <?php 
                include "config/db_config.php";
                include "getProducts.php";

                $sql = "SELECT ProductId, ProductBrand, Description, Price, Image, Rating FROM product WHERE CategoryId = 8";
