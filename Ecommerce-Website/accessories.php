...
<body>
    ...
    <section id="page-header">
        <h2>#Accessories</h2>
        <p>Master of materials</p>
        
    </section>

    <section id="product1" class="section-p1">
        <h2>The <span style="color: #ff523b;">unconventional</span> beauty</h2>
        <p>New Arrivals</p>
        <div class="pro-container">
            <?php 
                ...
                $sql = "SELECT ProductId, ProductBrand, Description, Price, Image, Rating FROM product WHERE CategoryId = 9";
